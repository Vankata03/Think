...
struct CardStyle: Identifiable, Equatable {
    ...
    static let paper = CardStyle(
        id: "paper", name: String(localized: "Paper"),
    ...
    static let midnight = CardStyle(
        id: "midnight", name: String(localized: "Midnight"),
    ...
    static let clay = CardStyle(
        id: "clay", name: String(localized: "Clay"),
    ...
    static let forest = CardStyle(
        id: "forest", name: String(localized: "Forest"),
